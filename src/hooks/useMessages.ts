  ...
  const decryptOneMessage = useCallback(
    async (msg: Message, conversation: ConversationWithParticipants | undefined): Promise<DecryptedMessage | null> => {
      try {
        ...
        // For messages I sent: use recipient's key
        // For messages I received: use sender's key
        ...
        // For image messages: store raw "ciphertext|||iv" — ImageMessage component decrypts lazily
        // For text messages: decrypt immediately
